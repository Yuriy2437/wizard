...
const specs: [string, string][] = [
  ...
  ['Rated heat output (kW)', '995'],
  ['Seasonal Space Heating', '182,9%'],
  ['Seasonal Space Heating', '465'],
  ['ErP Level', 'A+++'],
  ...
  ['Rated heat output (kW)', '923'],
  ['Seasonal Space Heating', '131,9%'],
  ['Seasonal Space Heating', '337'],
  ['ErP Level', 'A++'],
  ['Sound pressure level', '46'],
  ['Sound power level (dB(A))', '60'],
...
export default function ProductPW050ES() {
  return (
    <ProductPageTemplate
      title='PW050-DKZLRS-E/S'
      image={{ src: '/Image-7.jpg', alt: 'PW050-DKZLRS-E/S' }}
      specs={specs}
    />
  );
}
